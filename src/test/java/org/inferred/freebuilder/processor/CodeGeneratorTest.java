...
import static org.inferred.freebuilder.processor.SourceLevel.JAVA_6;
import static org.inferred.freebuilder.processor.SourceLevel.JAVA_7;
...
public class CodeGeneratorTest {
  ...
  public void testSimpleDataType_j6() {
    ...
    new CodeGenerator().writeBuilderSource(sourceBuilder, metadata, JAVA_6);
  ...
  public void testSimpleDataType_j7() {
    ...
    SourceStringBuilder sourceBuilder = SourceStringBuilder.simple();
    new CodeGenerator().writeBuilderSource(sourceBuilder, metadata, JAVA_7);
